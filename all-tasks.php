                        ...
                        <tr class="add-task">
                            ...
                            <form id="add-task-form" method="post" action="add_task_handler.php">
                                ...
                                <td id="tt-name"><input type="text" name="task_name" id="task_name"
                                    value="<?php echo isset($_SESSION['inputs']['task_name']) ? htmlspecialchars($_SESSION['inputs']['task_name']) : ""; ?>"></td>
                                ...
                                <td id="tt-due"><input type="date" name="task_due" id="task_due" 
                                    value="<?php echo isset($_SESSION['inputs']['task_due']) ? htmlspecialchars($_SESSION['inputs']['task_due']) : date('Y-m-d')?>"></td>
