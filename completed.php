                ...
                <div class="tasks-table">
                    <table>
                        ...
                        <tr class="add-task">
                            ...
                            <form id="add-task-form" method="post" action="completed_add_task_handler.php">
                        ...
                        <?php
                            $lines = $dao->getCompletedTasks();
                            foreach ($lines as $line) {
                                echo "<tr>
                                    <td id='tt-placeholder'>
                                        <div class='mark-completed'>
                                            <form method='post' action='completed_task_status_handler.php'>
